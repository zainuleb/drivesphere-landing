      ...
      <div className="modal-content">
        ...
        <p>
          ...
          <ul className="modal-list">
            ...
            <li>
              To comply with legal obligations, such as verifying your
        ...
        <p>
          ...
          legal obligations. Once the data is no longer needed, we will securely
        ...
        <p>
          ...
          <ul className="modal-list">
            <li>
              With our service providers who assist us in delivering our
              services, such as payment processors and IT support.
            </li>
            <li>
        ...
        <p>
          ...
          disclosure, alteration, or destruction. We regularly review and update
          our security practices to ensure the ongoing protection of your
          information.
        </p>
        ...
        <p>
          ...
          information held by us. You also have the right to restrict or object
          to the processing of your personal data and the right to data
          portability. To exercise these rights or for any privacy-related
          inquiries, please contact us using the contact details provided below.
        </p>
        ...
        <button className="bd-btn-member" onClick={() => close()}>
          Close
        </button>
      </div>
    </div>
